  ...
  >
    <div class="flex flex-col">
      <div class="flex flex-col my-20">
        ...
        <button
          type="button"
          class="bg-[#161d52] fill-white hover:fill-[#161d52] transition ease-in-out duration-150 inline-flex text-white hover:text-[#161d52] border border-white hover:bg-white focus:ring-4 focus:outline-none focus:ring-white font-medium text-sm px-5 py-2.5 me-2 mb-2 mt-4"
        >
        ...
        <button
          type="button"
          class="bg-[#161d52] fill-white hover:fill-[#161d52] transition ease-in-out duration-150 inline-flex text-white hover:text-[#161d52] border border-white hover:bg-white focus:ring-4 focus:outline-none focus:ring-white font-medium text-sm px-5 py-2.5 me-2 mt-4"
        >
          <svg viewBox="0 0 128 128" width="20" height="20" class="mr-2">
            <g
              ><path
