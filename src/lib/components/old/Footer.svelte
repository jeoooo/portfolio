...
<footer class=" bg-[#161d52] border-t-4 py-2">
  <div
    class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-center text-sm font-bold text-white sm:text-center"
  >
    <span class="text-sm font-bold text-white sm:text-center">
      @jeooo | {currentYear} | Made with
    </span>
    <a href="https://svelte.dev/" target="_blank">
      <svg
        viewBox="0 0 128 128"
        height="20"
        class="ml-1 fill-white hover:fill-[#FF3E00] transition ease-in-out duration-150"
      >
        <path
    ...
    <a href="https://tailwindcss.com/" target="_blank">
      <svg
        viewBox="0 0 128 128"
        height="20"
        class="ml-1 fill-white hover:fill-[#38b2ac] transition ease-in-out duration-150"
      >
        <path
    ...
    <a
      ...
      target="_blank"
      class="hover:underline">particles.js</a
    >
    <!-- <ul
