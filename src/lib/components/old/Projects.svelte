  ...
  >
    ...
    <ol class="relative border-s border-gray-200">
      ...
      <li class="mb-10 ms-4">
        ...
        <a
          href="https://projectdestiny.vercel.app/"
          target="_blank"
          class="font-ibm-plex-mono text-lg text-white py-2 inline-flex items-center font-medium hover:underline"
        >
          <!-- Set text to white -->
        ...
        <p class="text-lg text-white pt-2 font-ibm-plex-sans">
          Project DESTINY is an unofficial, open-source Uptime Status Page
          designed to monitor the availability of critical educational websites
          in Davao City. This initiative aims to provide real-time information
          about the uptime status of key online platforms to ensure a seamless
